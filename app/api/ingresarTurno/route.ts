...
export async function POST(request: Request) {
    try {
        ...
        await db.query(
            "INSERT INTO turnos (usuario_id, nombre, correo, telefono, fecha, horario, estado_pago) VALUES (?, ?, ?, ?, ?, ?, 'pendiente')",
            [usuario?.userId ?? null, nombre, email, telefono, fecha, horario]
        );
